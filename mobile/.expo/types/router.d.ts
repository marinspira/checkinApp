...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)/login` | `/(auth)/owner` | `/(auth)/signup` | `/(guest)` | `/(publicScreens)/volunteers` | `/_sitemap` | `/account` | `/chat` | `/home` | `/login` | `/notifications` | `/owner` | `/signup` | `/volunteer` | `/volunteers`;
